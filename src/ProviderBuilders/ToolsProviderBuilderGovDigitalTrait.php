...
trait ToolsProviderBuilderGovDigitalTrait
{
    /**
     * @param array|string $payload
     */
    private function buildGovDigitalEnvelope(array|string $payload, string $service, ?string $versao): string
    {
        $data = $this->normalizePayload($payload);
        [$method, $requestTag] = $this->mapGovDigitalMethod($service);
     ...
     */
    private function mapGovDigitalMethod(string $service): array
    {
    ...
    private function buildGovDigitalSoapAction(string $service): string
    {
        [$method] = $this->mapGovDigitalMethod($service);
