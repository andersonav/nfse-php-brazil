...
final class AbacoAdapter implements ProviderAdapterInterface, ProviderRuntimeAdapterInterface
{
    ...
    public function buildRuntimePlan(
        ...
        return [
            'transport' => 'xml',
            'envelope' => [
                'method' => 'buildAbacoEnvelope',
                'args' => ['payload', 'service', 'profile.versao'],
            ],
            'soap_action' => [
                'method' => 'buildAbacoSoapAction',
                'args' => ['service', 'profile.versao'],
            ],
        ];
    }
}
